                  ...
                  <div className="flex items-center h-8  my-1 -mx-1.5">
                    ...
                    <span className="flex flex-row ml-auto laptop:mouse:invisible laptop:mouse:group-hover:visible">
                      <a
                        href={item.link}
                        target="_blank"
                        className="flex-row items-center border typo-callout font-bold cursor-pointer select-none focus-outline justify-center flex relative mr-2 px-3 text-sm rounded-xl"
                      >
