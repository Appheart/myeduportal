        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {newsData
            ...
            .map((item, index) => (
              ...
              >
                <div className="Card_header__ygcHv flex items-center h-8  my-1 -mx-1.5">
                  <a
                    aria-label="EDUPORA"
                  ...
                  <span className="flex flex-row ml-auto laptop:mouse:invisible laptop:mouse:group-hover:visible">
                    <a
                      href={item.link}
                      target="_blank"
                      className="small btn flex-row items-center border typo-callout font-bold no-underline shadow-none cursor-pointer select-none focus-outline justify-center flex relative mr-2 btn-primary px-3 rounded-xl"
                    >
                      ...
                      <svg
                        ...
                        className="w-6 h-6 pointer-events-none ml-2 icon"
                      >
                        <path
                    ...
                    <button
                      aria-label="Options"
                      className="iconOnly small btn flex-row items-center border typo-callout font-bold no-underline shadow-md cursor-pointer select-none focus-outline justify-center flex relative my-auto btn-tertiary bg-white"
                    >
                      <svg
                        width="1em"
                        height="1em"
                ...
                <div className="relative flex flex-1 flex-col">
                  <img
                    ...
                    className="object-cover my-2 rounded-xl h-40 shadow-md"
                    loading="lazy"
                  />
                  <div className="mt-4 flex flex-row items-center mx-4 justify-between gap-3">
                    <div className="small btn-quaternary flex flex-row items-stretch select-none btn-tertiary-avocado w-[4.875rem]">
                      <button
                        aria-label="Upvote"
                        id="post-f68Bw6QQH-upvote-btn"
                        className="iconOnly small btn flex-row items-center border typo-callout font-bold no-underline shadow-md cursor-pointer select-none focus-outline justify-center flex relative bg-white"
                      >
                        <svg
                          width="1em"
                          height="1em"
                    ...
                    <div className="small btn-quaternary flex flex-row items-stretch select-none btn-tertiary-blueCheese w-[4.875rem] gap-3">
                      <button
                        aria-label="Comments"
                    ...
                    <button
                      ...
                      className="iconOnly small btn flex-row items-center border typo-callout font-bold no-underline shadow-md cursor-pointer select-none focus-outline justify-center flex relative btn-tertiary-cabbage bg-white"
                    >
                      <svg
                        width="1em"
                        height="1em"
