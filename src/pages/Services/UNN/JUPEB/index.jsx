          ...
          <div className="max-w-5xl m-auto flex flex-col gap-3">
            <div className="section-title p-3 shadow-md text-lg text-center text-green-700 mb-5 rounded-md flex justify-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <h3 className="font-bold">JUPEB Application</h3>
              </div>
            </div>
            <section className="w-full mx-auto space-y-5">
              ...
              <details className="rounded-lg shadow-sm px-3 py-2">
                ...
                <div className="mt-3 flex flex-col gap-3 text-sm pl-4">
                  <p>
                    To get started with geerating your JUPEB Application
                    invoice, you will be required to enter your valid mobile
                    &nbsp;
                    <b>phone number</b> .
                  </p>

                  <p>
                    Next, you will fill in your valid information such as your
                    &nbsp;
                    <b>surname</b> , <b>firstname</b>, <b>middlename</b>,&nbsp;
                    and &nbsp;
                    <b>email address</b>.
                  </p>
                  <p>
                    In the box where <b>Reg No</b> is requested for, fill in
                    with <b>2022/2023</b>
                  </p>
                  <p>
                    After which, you press the{' '}
                    <b className="px-2 bg-green-600 text-white">Submit</b>{' '}
                    button
                  </p>
                  <p>
